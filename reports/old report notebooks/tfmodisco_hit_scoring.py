...
def main(
    ...
    # try to fix imp coords??
    # imp_coords[:,1] -= input_length // 2
    # imp_coords[:,2] = imp_coords[:,1] + input_length    # REMOVED AS OF SEP 25
    ...
    hit_scorer = densityadapted_hitscoring.MakeHitScorer(
        ...
        n_cores=80  # used to be n_cores=10, I switched to 80 for speed
    )
